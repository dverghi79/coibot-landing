// resend-notify.js — COIBot LP
// Required env vars: RESEND_API_KEY, RESEND_FROM_EMAIL, CONTACT_EMAIL
// RESEND_SEGMENT_ID defaults to the COIBot waitlist segment if not overridden.

const PRODUCT_SEGMENT_ID = '9b1ef940-5101-45cb-8125-ac7ba6f8881f'; // Waitlist-COIBot
...
module.exports = async function handler(req, res) {
  ...
  const productName = product || 'COIBot';
